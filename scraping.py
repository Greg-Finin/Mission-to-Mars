...
def scrape_all():
    ...
    hemisphere_dict, hemispheres, Cerebus_Title, Cerebus_Img, Schiaparelli_Title, Schiaparelli_Img, Syrtis_Title, Syrtis_Img, Valles_Title, Valles_Img = mars_hempispheres(browser)
    ...
    data = {
        ...
        "Cerebus_Title":Cerebus_Title,
        "Cerebus_Img":Cerebus_Img,
...
def mars_hempispheres(browser):
    ...
    combined_list
    combined_list
    Cerebus_Title = combined_list[0]
    Cerebus_Img = combined_list[1]
    Schiaparelli_Title = combined_list[2]
    Schiaparelli_Img = combined_list[3]
    Syrtis_Title = combined_list[4]
    Syrtis_Img = combined_list[5]
    Valles_Title = combined_list[6]
    Valles_Img = combined_list[7]
    ...
    return hemisphere_dict, hemispheres, Cerebus_Title, Cerebus_Img, Schiaparelli_Title, Schiaparelli_Img, Syrtis_Title, Syrtis_Img, Valles_Title, Valles_Img
